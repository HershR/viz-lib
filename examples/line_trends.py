...
usage = pd.DataFrame(
    {
        ...
        "plan": ["Pro"] * 12 + ["Free"] * 12,
        "active_users": [
            5, 9, 14, 21, 25, 30, 38, 46, 52, 60, 68, 74,     # Pro
            20, 24, 27, 30, 34, 36, 41, 44, 47, 51, 55, 58,    # Free
        ],
    }
)

# Multiple series: one categorical hue each, with a legend.
ax = viz.line(usage, x="month", y="active_users", by="plan",
...
ax = viz.line(usage, x="month", y="active_users", by="plan", highlight="Pro",
